...
The final data set can be found in the `tidyMeans.csv` file, which can be read into R with `read.csv("tidyMeans.csv", header = TRUE)`. A detailed description of the variables can be found in `CodeBook.md`. The basic naming convention is:
